...
import MusicSfxClient from '../music-sfx/MusicSfxClient'; // Reusing the same client component
...
export const metadata: Metadata = {
  ...
  description: 'Browse our collection of royalty-free stock music. Download high-quality audio tracks for your projects.',
};
  ...
  if (!category) {
    ...
    return (
      <Suspense fallback={<LoadingSpinnerServer message="Loading stock music library..." />}>
        <MusicSfxClient initialTemplates={[]} />
      </Suspense>
    );
  }
