  ...
  return (
    <section className="relative w-full py-20 sm:py-24 md:py-28 overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 left-1/2 w-96 h-96 bg-pink-500/20 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2"></div>
        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-purple-500/5 to-pink-500/5"></div>
      </div>

      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
        {/* Main CTA Card */}
        <div className="relative rounded-[1.5rem] border-[0.75px] border-white/10 p-2">
          <GlowingEffect
            spread={40}
            glow={true}
            disabled={false}
            ...
            borderWidth={3}
          />
          <div className="relative rounded-xl border-[0.75px] border-white/10 bg-black/60 backdrop-blur-sm p-8 sm:p-12 md:p-16 shadow-sm dark:shadow-[0px_0px_27px_0px_rgba(45,45,45,0.3)]">
            {/* Content */}
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <Link
                  href="/templates"
                  className="relative px-8 py-3 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm text-white font-semibold text-sm hover:bg-white/10 hover:border-white/30 transition-all duration-200"
                >
                  Browse Templates
                </Link>
              </div>
