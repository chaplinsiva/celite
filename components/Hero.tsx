...
// agent-notes: { ctx: "Hero black box with floating blue border glow and white text", deps: [next/link, framer-motion, lucide-react], state: active, last: "sato@2026-09-01" }
