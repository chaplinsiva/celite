            ...
            <div className="relative z-10 flex-1 flex flex-col justify-center p-6 md:p-10">
              ...
              >
                <p className="text-base sm:text-lg md:text-xl font-bold text-white leading-tight mb-2">
                  Premium After Effects templates — wedding save the dates, cinematic intros, slideshows, stock music &amp; SFX
                </p>
                <p className="text-white/60 text-[10px]">
                  Unlimited downloads • After Effects • Wedding &amp; Save the Date Templates
                </p>
              </motion.div>
            </div>
          </div>
