        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-zinc-400 max-w-md leading-relaxed">
              Professional marketplace for premium After Effects templates. Download wedding save the date videos, cinematic intros, motion graphics, stock music & SFX. Elevate your creative projects with our curated collection.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link href="/3d-models" className="text-zinc-400 hover:text-white transition-colors">
                  3D Models
                </Link>
              </li>
              <li>
                <Link href="/stock-photos" className="text-zinc-400 hover:text-white transition-colors">
                  Stock Photos
                </Link>
              </li>
              <li>
                <Link href="/music-sfx" className="text-zinc-400 hover:text-white transition-colors">
                  Music &amp; SFX
                </Link>
              </li>
            </ul>
